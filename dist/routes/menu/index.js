...
var _menu = require("../../dto/menu.dto");
var _errors = require("../../lib/errors");
var _validations = require("../../middlewares/validations");
var _menu2 = require("../../models/menu");
...
router.get('/', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$query, _req$query$page, page, _req$query$limit, limit, _yield$Promise$all, _yield$Promise$all2, menus, count;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return Promise.all([_menu2.Menu.find({
            isDeleted: false
          }).skip((page - 1) * limit).limit(limit), _menu2.Menu.count({
            isDeleted: false
          })]);
        case 4:
          _yield$Promise$all = _context.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
          menus = _yield$Promise$all2[0];
          count = _yield$Promise$all2[1];
          res.json((0, _menu.getMenuResponseDTO)(menus, page, limit, count));
          _context.next = 14;
          break;
        case 11:
          _context.prev = 11;
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          res.json((0, _menu.getMenuByIdResponseDTO)(menu));
          _context2.next = 13;
          break;
        case 10:
          _context2.prev = 10;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _menu2.Menu.create({
            name: req.body.name,
            description: req.body.description
          });
        case 3:
          menu = _context3.sent;
          res.json((0, _menu.getCreateMenuResponseDTO)(menu));
          _context3.next = 10;
          break;
        case 7:
          _context3.prev = 7;
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _menu2.Menu.findOneAndUpdate({
            _id: req.params.id,
            isDeleted: false
          }, {
            isDeleted: true
        ...
        case 6:
          res.json((0, _menu.getDeleteMenuResponseDTO)(deleted));
          _context4.next = 12;
          break;
        case 9:
          _context4.prev = 9;
...
router.patch('/:id', _validations.validateObjectId, /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res, next) {
    var toUpdate, _req$body, name, description, updated;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 10:
          res.json((0, _menu.getUpdateMenuResponseDTO)(updated));
          _context5.next = 16;
          break;
        case 13:
          _context5.prev = 13;
