...
router.get("/", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$query, _req$query$page, page, _req$query$limit, limit, _yield$Promise$all, _yield$Promise$all2, activities, count;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return Promise.all([_activities.Activities.find().skip((page - 1) * limit).limit(limit), _activities.Activities.count()]);
        case 4:
          _yield$Promise$all = _context.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
          activities = _yield$Promise$all2[0];
          count = _yield$Promise$all2[1];
          res.json((0, _activitie_duration.getActivitiesResponseDTO)(activities, page, limit, count));
          _context.next = 14;
          break;
        case 11:
          _context.prev = 11;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          id = req.params.id;
          _context2.next = 4;
          return _activities.Activities.findOne({
            _id: id
          });
        case 4:
          activitie = _context2.sent;
          if (activitie) {
            _context2.next = 7;
            break;
          }
        ...
        case 7:
          res.json((0, _activitie_duration.getActivitieByIdResponseDTO)(activitie));
          _context2.next = 13;
          break;
        case 10:
          _context2.prev = 10;
...
router.post("/", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
    var _req$body, body, activity, date1, action, idModule, date, recentActivity, err, heure_arret, heure_demarrage, dureeFonctTemporaire, _err, _err2;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          date1 = new Date();
          action = body.action, idModule = body.idModule, date = body.date; //recherche de la donnnée la plus récente d'un module
          _context3.next = 6;
        ...
        case 23:
          ...
          _context3.next = 29;
          return _module.Module.findByIdAndUpdate(idModule, {
            $inc: {
        ...
        case 34:
          ...
          break;
        case 36:
          _err2 = new Error("Type d'action non reconnu");
          _err2.status = 500;
          throw _err2;
        case 39:
          res.json((0, _activitie_duration.getCreateActivitieResponseDTO)(activity));
          _context3.next = 46;
          break;
        case 42:
          _context3.prev = 42;
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _activities.Activities.findByIdAndRemove(req.params.id);
        case 3:
          ...
          throw new _errors.NotFoundError("No activitie deleted");
        case 6:
          res.json((0, _activitie_duration.getDeleteActivitieResponseDTO)(deleted));
          _context4.next = 12;
          break;
        case 9:
          _context4.prev = 9;
